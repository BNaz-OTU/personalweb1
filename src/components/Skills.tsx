...
const skillIcons = [
  ...
  {
    icon: <Image src={Cplusplus} className="w-auto h-[100px] md:h-[140px]" />,
    label: "C++",
  },
  {
    icon: <Image src={matlab} className="w-auto h-[100px] md:h-[140px]" />,
    label: "MATLAB",
  },
  {
    icon: <Image src={nextJ} className="w-auto h-[100px] md:h-[140px]" />,
    label: "Next.JS",
  },
  {
    icon: <Image src={jQuery} className="w-auto h-[100px] md:h-[140px]" />,
    label: "jQuery",
  },
  {
    icon: <Image src={maven} className="w-auto h-[100px] md:h-[140px]" />,
    label: "Maven",
  },
  {
    icon: <Image src={mySQL} className="w-auto h-[100px] md:h-[140px]" />,
    label: "MySQL",
  },
  {
    icon: <Image src={postg} className="w-auto h-[100px] md:h-[140px]" />,
    label: "PostgreSQL",
  },
  {
    icon: <Image src={springb} className="w-auto h-[100px] md:h-[140px]" />,
    label: "Spirng Boot",
  },
  ...
  {
    icon: <Image src={pandas} className="w-auto h-[100px] md:h-[140px]" />,
    label: "Pandas",
  },
  {
    icon: <Image src={numpy} className="w-auto h-[100px] md:h-[140px]" />,
    label: "NumPy",
  },
  {
    icon: <Image src={Gcloud} className="w-auto h-[100px] md:h-[140px]" />,
    label: "Google Cloud",
  },
  {
    icon: <Image src={pytorch} className="w-auto h-[100px] md:h-[140px]" />,
    label: "PyTorch",
  },
  {
    icon: <Image src={opencv} className="w-auto h-[100px] md:h-[140px]" />,
    label: "OpenCV",
  },
  {
    icon: (
